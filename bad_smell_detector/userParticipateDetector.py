def issueParticipateDetector():
	...
	print('eachMemberIssueParticipateTimes',eachMemberParticipateTimes)
	print('eachMemberCommitTimes',eachMemberCommitTimes)
	...
	for i in range(len(eachMemberParticipateTimes)):
		...
		if ratio1 < 0.1 or ratio2 < 0.1:
			print("Badsmell: This user is likely to be a 'passenger'.")
		elif ratio1 > 0.75 or ratio2 > 0.75:
			print("Badsmell: This user is likely to be a 'great dictator'.")
		else:
			print("The participant of this user is normal.")
